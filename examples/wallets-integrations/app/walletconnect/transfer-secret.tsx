...
export function TransferSecret({ sdk, chainId, address, provider, log }: TransferSecretProps) {
  // ---- Local state ----
  ...
  }, [sdk, chainId, address, provider, secretId, newOwner, log])
