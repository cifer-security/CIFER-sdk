...
export function DecryptPayload({ sdk, chainId, account, log }: DecryptPayloadProps) {
  // ---- Local state ----
  ...
  }, [sdk, chainId, account, secretId, encryptedMessage, cifer, log])
