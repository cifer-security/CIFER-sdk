...
import { CheckCircle, Loader2, Lock, Upload, FileUp, X } from "lucide-react"
...
export function EncryptFile({ sdk, chainId, address, provider, log }: EncryptFileProps) {
  // ---- Local state ----
