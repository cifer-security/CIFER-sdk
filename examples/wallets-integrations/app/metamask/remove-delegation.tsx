...
export function RemoveDelegation({ sdk, chainId, address, log }: RemoveDelegationProps) {
  // ---- Local state ----
  ...
  //
  // keyManagement.buildRemoveDelegationTx() returns a TxIntent that calls
  // setDelegate(secretId, address(0)) on the SecretsController.
  //
  // Only the secret owner can remove the delegation.
  // =========================================================================
  ...
  }, [sdk, chainId, address, secretId, log])
