 ...
 *   3. Send the transaction using MetaMask's window.ethereum (EIP-1193)
...
export function CreateSecret({ sdk, chainId, address, log }: CreateSecretProps) {
  // ---- Local state ----
  ...
  // 3. eth_sendTransaction     → MetaMask sends the tx (user confirms)
  ...
  const handleCreateSecret = useCallback(async () => {
    ...
    try {
      ...
      log("Please confirm the transaction in MetaMask...")
  ...
  return (
    <div className="glow-card p-6">
      ...
      <p className="text-sm text-zinc-400 mb-4">
        ...
        MetaMask, then waits for the enclave to generate keys.
      </p>
